...
~/go/bin/familiesFromLiftAndMerge families/200bp/cmDiff/fqComb/combinedMergedPeaks.cmDiff.trim50.liftAndMerge.200bp.bed families/200bp/cmDiff/fqComb/cmDiff_fqComb.$2.regEleFam.200bp.bed families/200bp/cmDiff/fqComb/cmDiff_fqComb.$2.regEleFam.200bp.txt /dev/null

cat families/200bp/$3/cmDiff_fqComb.$2.regEleFam.200bp.bed | grep -v "lonely" > families/200bp/cmDiff/fqComb/cmDiff_fqComb.$2.regEleFam.200bp.noLonely.bed
